package com.amiao.vod.controller;
...
import com.amiao.vod.Utils.ConstantVodUtils;
import com.amiao.vod.Utils.InitVodClient;
import com.amiao.vod.service.VodService;
...
public class VodController {
    ...
    public R removeAlyVideo(@PathVariable String id){
        try {
            ...
            e.printStackTrace();
            throw new AmiaoException(20001,"删除视频失败");
        }
    }
...
//            GetVideoPlayAuthResponse response1=new GetVideoPlayAuthResponse();
            ...
            throw new AmiaoException(20001,"获取凭证失败");
        }
    }
}
